...
<?php endwhile; ?>
    ...
    <fieldset>
      ...
      <div class="field">
        ...
        <input class="textfield monofont" type="text" id="msn" name="msn" maxlength="200"/>
      </div>
...
<?php
$javascripts = array('datepicker/WdatePicker', 'jquery-1.7.1.min', 'profile/new.min','profile/city');
