...
<?php endif; ?>
<section class="main">
  <p>十年前的3月，上海交通大学夺得ACM国际大学生程序设计竞赛世界冠军，这是亚洲有史以来该赛事的第一个世界冠军，也是交大计算机专业的本科生有史以来第一次站在世界舞台的最高点。</p>
  <p>这一成绩给予了我们极大地鼓舞，同时我们思考：如果我们的学生能够站在世界科学舞台的最高点，那将更加彰显中国实力。由此揭开了上海交通大学计算机科学与技术高瑞人才培养的序幕⋯⋯<span style="font-style:italic">（<a href="<?php echo SITE_BASE; ?>/intro">继续阅读ACM班简介</a>）</span></p>
  <div class="columns">
    <section>
      <h2>新闻</h2>
      <ul>
